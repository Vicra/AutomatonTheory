...
public class Validation extends JFrame
{
	...
	public Validation()
	{
		...
		try
		{
			Object v1 = graph.insertVertex(parent, null, "source", 20, 20, 80, 30);
			Object v2 = graph.insertVertex(parent, null, "target", 200, 20, 80, 30);
			...
			Object v5 = graph.insertVertex(parent, null, "v5", 200, 40, 80, 30);
			...
			mxCell trans1 = (mxCell)(graph.insertEdge(parent, null, "", v1, v2));
			System.out.println("Source: " + trans1.getSource().getValue());
			System.out.println("Target" + trans1.getTarget().getValue());
			graph.insertEdge(parent, null, "", v1, v3);
			graph.insertEdge(parent, null, "", v6, v4);
			graph.insertEdge(parent, null, "", v1, v1);
			//graph.removeCells(new Object[]{v5});
